...
parser.add_argument('--model', default='MVFGAP', help='Model name: dgcnn')
parser.add_argument('--log_dir', default='log', help='Log dir [default: log]')
# parser.add_argument('--data_set_opt', default='ModelNet40', help='Data_set opt [default: ModelNet40]')
parser.add_argument('--data_set_opt', default='ModelNet10', help='Data_set opt [default: ModelNet40]')
...
if DATA_SET == 'ModelNet40':
    ...
    TRAIN_FILES = provider.getDataFiles(os.path.join(BASE_DIR, 'data/modelnet10_ply_hdf5_2048/train_files.txt'))
    TEST_FILES = provider.getDataFiles(os.path.join(BASE_DIR, 'data/modelnet10_ply_hdf5_2048/test_files.txt'))
